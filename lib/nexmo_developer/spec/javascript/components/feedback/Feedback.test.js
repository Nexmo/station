...
describe('Feedback', function() {
  ...
  it('renders the different paths the user can take', function() {
    const wrapper = shallowMount(Feedback, { propsData: { paths: paths, title: title, codeLanguage: undefined }})
        ...
        { id: '123' },
        {
          ...
          body: {
            "feedback_feedback": {
              ...
              "email": null,
              "code_language": "ruby",
              "code_language_selected_whilst_on_page": null,
              "code_language_set_by_url": true
            }
          }
        }
      )

      const wrapper = shallowMount(Feedback, { propsData: { paths: paths, title: title, source: source, configId: configId, codeLanguage: 'ruby' }})
