  ...
  "results": [
    {
      "hits": [
        {
          ...
          "path": "/client-sdk/setup/generate-test-credentials",
          "document_path": "/app/_documentation/client-sdk/setup/generate-test-credentials.md",
          "body": "\n\n  \n\nFurther informationYou can read more about the JWT and ACL in this topic.",
          "product": "client-sdk",
          "objectID": "7952741",
          "_snippetResult": {
            "body": {
              "value": "\n\n  \n\nFurther informationYou can read more about the JWT and",
              "matchLevel": "none"
            }
          },
          "_highlightResult": {
            "title": {
              "value": "How to Generate <em>Test</em> Credentials",
              "matchLevel": "full",
            ...
            "description": {
              "value": "This topic shows you how to create a Nexmo application, users and tokens.",
              "matchLevel": "none",
              "matchedWords": []
            },
            "body": {
      ...
      "query": "test",
      "params": "query=test",
      "index": "production_nexmo_developer"
    },
    {
      "hits": [
        {
