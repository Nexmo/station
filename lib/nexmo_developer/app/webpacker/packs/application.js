...
window.setDigitalData = setDigitalData
...
console.log('process.env.ADOBE_LAUNCH_PRIMARY_CATEGORY', process.env.ADOBE_LAUNCH_PRIMARY_CATEGORY)
// console.log('DIGITAL_DATA', DIGITAL_DATA)
